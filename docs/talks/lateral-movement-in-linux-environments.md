...
Ptrace injection, some DBus stuff for dumping keyrings, some SSH agent hijinks. All the fun things you can do once you get user-level access on a Linux target.
